...
public class loginPage extends Stage implements LibWindow {
	...
	public void init() {
		...
		passWord.setFont(Font.font("Gotham", FontWeight.NORMAL, 15));
		...
		userNameField.setFont(Font.font("optima", FontWeight.NORMAL, 15));
		userNameField.setMaxWidth(250.0);
		userNameField.setPrefHeight(40.0);

		PasswordField passwordField = new PasswordField();
		passwordField.setPromptText("Enter Passowrd");
		passwordField.setFont(Font.font("optima", FontWeight.NORMAL, 15));
